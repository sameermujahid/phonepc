					...
					<div class="col-xl-12 col-lg-12">
						<div class="card">
							...
							<div class="card-body">
                                ...
                                <?php
// Assuming you have retrieved the selected Task_id, employeeId, and employeeName from the previous page or by other means
...
if ($result->num_rows > 0) {
    ...
    // Display the task details in the HTML form
    echo '
    <div class="row">
    ...
    <form action="process_reply.php" method="POST">
        ...
        <div class="mb-3 col-md-12">
            <label class="form-label">Reply Task</label>
            <textarea class="form-control" name="replyTask"></textarea>
        </div>
        <div class="mb-3 col-md-12">
            <button type="submit" class="btn btn-primary" name="submitReply">Submit Reply</button>
